                        ...
                        <div className="rounded-2xl p-2 sm:p-3 mt-2 border border-[#b8ddf8] shadow-xl w-full bg-white relative overflow-hidden">
                            <div className="flex flex-col gap-2 pb-2">
                                ...
                                <div className="flex items-center gap-2">
                                    <button onClick={addTable} className="flex items-center gap-1 bg-[var(--endeavour)] text-white text-xs font-medium px-3 h-7 rounded-full hover:opacity-90 transition-all">
                                        + {getTtl('Add Table', ln) || 'Add Table'}
                                    </button>
                                    <button onClick={saveTable} className="flex items-center text-[var(--endeavour)] border border-[var(--rock-blue)] text-xs font-medium px-3 h-7 rounded-full hover:bg-[var(--selago)] transition-all">
                                        {getTtl('Save', ln) || 'Save'}
                                    </button>
                                </div>
                            </div>
                            ...
                            {(data.length && !Object.values(totals).some(v => isNaN(v))) ? (
