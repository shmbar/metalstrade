        ...
        <div className='items-center flex'>
          <Menu as="div" className="relative inline-block text-left">
            <div className='flex h-full'>
              <Menu.Button className="flex items-center justify-center px-4 text-lg text-slate-800 focus:outline-none">
            ...
            >
              <Menu.Items className="absolute left-2 mt-2 w-48 origin-top-left divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                        ...
                        {x.items.map((y, k) => {
                          ...
                          return (
                            <Link href={`${y.page}`} key={k}>
                              <div className="flex p-2 py-1 text-sm flex items-center ">
                                <div className={`gap-2 items-center w-full text-gray-600 flex items-center p-2 hover:bg-slate-400 hover:text-white rounded-lg 
