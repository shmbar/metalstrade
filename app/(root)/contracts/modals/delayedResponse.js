                ...
                <div className="border border-[var(--line)] rounded-2xl overflow-hidden">
                    <table id='my-table' className="table-fixed min-w-full divide-y divide-[var(--line)]">
                        <thead style={{ background: 'var(--bg-subtle)' }}>
                            <tr>
                                <th scope="col" className="w-0/12 py-2 px-4 text-left responsiveTextTable font-medium text-[var(--chathams-blue)]">Supplier</th>
                                <th scope="col" className="w-0/12 pr-1 py-2 text-left responsiveTextTable font-medium text-[var(--chathams-blue)]">
                                    Contract</th>
                                <th scope="col" className="w-0/12 pr-1 py-2 text-left responsiveTextTable font-medium text-[var(--chathams-blue)]">
                                    Date</th>
                                <th scope="col" className="w-20 pr-1 py-2 text-left responsiveTextTable font-medium flex text-[var(--chathams-blue)]">
                                    Days from Date</th>
                                <th scope="col" className="w-20 pr-1 py-2 text-left responsiveTextTable font-medium text-[var(--chathams-blue)]">
                                    Keep Alerting</th>
                            </tr>
                        </thead>
