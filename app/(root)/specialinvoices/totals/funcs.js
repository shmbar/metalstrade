...
export const expensesToolTip = (row, expensesData, settings, filt) => {
    ...
    const thStyle = { textAlign: 'center', padding: '6px 10px', color: 'var(--chathams-blue)', fontWeight: 500, fontSize: '0.68rem', border: '1px solid var(--border-divider)', background: 'var(--surface-header)', whiteSpace: 'nowrap' }
    const tdStyle = { textAlign: 'center', padding: '5px 10px', border: '1px solid var(--selago)', fontSize: '0.68rem', color: 'var(--chathams-blue)', whiteSpace: 'nowrap' }
