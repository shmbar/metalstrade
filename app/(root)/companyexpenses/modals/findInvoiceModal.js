...
const FindInvoiceModal = ({ open, setOpen, uidCollection, value, setValue }) => {
    ...
    return (
        <Modal isOpen={open} setIsOpen={setOpen} title="Find Invoice" w="max-w-md">
            <div className="flex flex-col gap-3 p-3">
                <div className="flex flex-col gap-1">
                    <p className="responsiveTextInput font-medium text-[var(--chathams-blue)]">Invoice Number:</p>
                    <input
                        className="input h-7 responsiveTextInput rounded-full border-[var(--line)] bg-[var(--bg-card)] w-40"
                        value={invoice}
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <input
                        className="input h-7 responsiveTextInput rounded-full border-[var(--line)] bg-[var(--bg-card)] w-20"
                        value={year}
