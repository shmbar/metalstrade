        ...
        <Modal isOpen={open} setIsOpen={setOpen} title="Find Invoice" w="max-w-sm">
            <div className="flex flex-col gap-3 p-3">
                <div className="flex flex-col gap-1">
                    ...
                    <input
                        className="input h-7 text-xs rounded-full border-[var(--border-divider)] bg-white w-40"
                        value={invoice}
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <input
                        className="input h-7 text-xs rounded-full border-[var(--border-divider)] bg-white w-20"
                        value={year}
