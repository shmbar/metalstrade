...
//                                 <div className="px-3 py-1.5 rounded-lg text-[11px] font-normal"
//                                   style={{
...
//                               <div className="flex justify-center">
//                                 {hasValue ? (
//                                   <div className="px-3 py-1.5 rounded-lg text-[11px] font-normal min-w-[70px] text-center transition-all duration-200 ease-in-out"
//                                     style={{
