	...
	const setCurFilterData = (arr) => {
		...
		arr.forEach(obj => {
			...
			materialsArr.forEach(x => {
				...
				newObj = {
					supplier: obj.supplier, originSupplier: obj.originSupplier, date: obj.date, order: obj.order, poWeight: total,
				...
				<>
					...
					<div className="border border-[#b8ddf8] rounded-xl p-4 mt-8  bg-white relative">
						<div className='flex items-center justify-between flex-wrap pb-2'>
							<h1 className="text-[var(--chathams-blue)] font-poppins responsiveTextTitle font-medium border-l-4 border-[var(--chathams-blue)] pl-2">{getTtl('Contracts Statement', ln)}</h1>
