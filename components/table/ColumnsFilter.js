...
const Item = React.memo(({ value, handleToggleCols }) => {
			...
			<div className="relative">
				...
				{open &&
					<div className="right-0 absolute z-10 mt-3 transform px-2 sm:px-0">
						<div className="overflow-auto max-h-80 md:max-h-full md:overflow-hidden rounded-lg shadow-lg bg-white py-4 px-2 w-full">
