...
export default function NavbarLinks() {
  ...
  return (
    <div className="flex items-center gap-1">
      ...
      <Link
        href="/signin"
        className="ml-2 bg-[var(--endeavour)] text-white text-sm px-5 py-2 rounded-lg hover:bg-[var(--brand-deep)] transition-all duration-200 font-medium shadow-sm hover:shadow-md hover:scale-105 active:scale-95"
      >
        Sign In
      </Link>
    </div>
