            ...
            <div className="absolute z-dropdown top-7 transform px-2 ml-10 sm:px-0">
                <Transition show={openMonth} enter="transition-opacity duration-300"
                    ...
                    <div className="overflow-hidden rounded-2xl shadow-xl bg-[var(--bg-card)] w-full border border-[var(--bg-subtle)]">
                        <div className='py-1.5 px-3 responsiveText font-semibold' style={{ background: 'var(--bg-subtle)', color: 'var(--chathams-blue)' }}>Select Month</div>
                        <div className='py-1 px-1 overflow-auto max-h-72'>
                            {months.map((x, i) => {
                                return (
                                    <div key={i} className='responsiveText py-1 px-2 cursor-pointer hover:bg-[var(--bg-subtle)] rounded-lg flex gap-2 items-center transition-colors'
                        ...
                        <div className='border-t border-[var(--bg-subtle)] px-1 pb-1'>
                            <div className='mt-1 responsiveText py-1 px-2 cursor-pointer hover:bg-[var(--bg-subtle)] rounded-lg flex gap-2 items-center transition-colors'
                                style={{ color: 'var(--chathams-blue)' }}
                                onClick={selectAll}>
