                ...
                <div className="relative">
                    ...
                    >
                        <Portal>
                            ...
                            bg-[var(--bg-card)] py-1 responsiveTextInput shadow-lg border border-[var(--bg-subtle)] focus:outline-none ${classes1}`}>
                            {filteredData.length === 0 && query !== '' ? (
                                ...
                                filteredData.map((x) => ( //slice(1)
                                    <ComboboxOption
                                        key={x.id}
                                        className={cn(
                                            'relative cursor-default select-none py-1 responsiveTextInput pl-10 pr-4 text-[var(--port-gore)] hover:bg-[var(--bg-subtle)] hover:text-[var(--endeavour)]',
                                            selected.id === x.id
