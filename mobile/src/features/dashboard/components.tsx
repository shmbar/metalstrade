      ...
      <View style={{ flexDirection: 'row', gap: 12 }}>
        <View style={{ flex: 1, backgroundColor: '#ecfdf522', borderRadius: radius.md, borderWidth: 1, borderColor: '#a7f3d055', padding: 10 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
            ...
            <Text variant="captionStrong" color={colors.positive}>
              FINALIZED
            </Text>
          </View>
          ...
          return (
            <View key={b.label} style={{ flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 10 }}>
              ...
              <View style={{ width: 84, alignItems: 'flex-end' }}>
                {curs.length ? (
                  curs.map((c) => (
                    <Text key={c} variant="captionMedium">
        ...
        rows.map((r, i) => {
          ...
          return (
            <View key={r.name + i} style={{ flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 8 }}>
              ...
              >
                <Text variant="captionStrong" color="#fff">
                  {initials(r.name)}
                </Text>
              </View>
              <View style={{ flex: 1 }}>
              ...
              <Text variant="captionStrong" numberOfLines={1} adjustsFontSizeToFit style={{ width: 64, textAlign: 'right' }}>
